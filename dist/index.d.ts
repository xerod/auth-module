...
export declare function moka(nuxt: any, strategy: ProviderPartialOptions<MokaProviderOptions>): void;

export declare interface MokaProviderOptions extends ProviderOptions, Oauth2SchemeOptions {
}
