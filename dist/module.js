...
const axios2__default = /*#__PURE__*/_interopDefaultLegacy(axios2);
...
const authModule = function(moduleOptions) {
  ...
  options2.defaultStrategy = options2.defaultStrategy || strategies.length ? strategies[0].name : "";
  ...
  if (options2.plugins) {
    options2.plugins.forEach((p) => this.options.plugins.push(p));
